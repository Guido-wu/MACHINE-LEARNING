...
def afficher_bandeau_covers(df_items):
    ...
    img_tags = "".join([f'<img src="{url}" style="height:400px; width:300px;object-fit:cover; margin: 0 10px; border-radius:10px; box-shadow: 2px 2px 10px rgba(0,0,0,0.2);">' for url in covers + covers])
